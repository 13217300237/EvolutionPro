...
public class QuoteFragmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuoteFragment quoteFragment = QuoteFragment.newInstance(null);
        showFragment(quoteFragment);
    }
