...
public class DealFragmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DealFragment dealFragment = DealFragment.newInstance(null);
        showFragment(dealFragment);
    }
